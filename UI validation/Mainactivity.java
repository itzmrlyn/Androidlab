...
Pattern PHONE_PATTERN=Pattern.compile("^[7-9][0-9]{9}$"); //Begins with 0 or
91,then 7 or 8 or 9,then contains 9 digits
...
pass.setError("Password is too weak[small letter,digits and special characters and
end with capitals]");
